	...
	<body>
		...
		<div id="resetpassword">
			<center>
				...
				<form method="POST" action="" id="resetpass">
					<div id="passwordnotmatch" style="color:red; font-weight:bold;"></div>
					<center>
					<table>
						<tr>
						...
						<tr>
							<th></th>
							<td><input type="submit" id="submitpass" name="submitpass" value="Reset Password" disabled></td>
						</tr>
					</table>
				</center>
				</form>
